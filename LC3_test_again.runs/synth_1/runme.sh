...
HD_PWD='F:/Testlc3/LC3_test_again/LC3_test_again.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_Bench.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TEST_Bench.tcl
